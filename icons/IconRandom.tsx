...
class IconRandom extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--random ${p.className || ""}`
        return (
