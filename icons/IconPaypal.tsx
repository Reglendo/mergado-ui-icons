...
class IconPaypal extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--paypal ${this.props.addClass} ${this.props.className}`
