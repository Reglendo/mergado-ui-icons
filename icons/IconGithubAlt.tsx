...
class IconGithubAlt extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--github-alt ${p.className || ""}`
        return (
