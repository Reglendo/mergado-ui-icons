...
class IconFeedimageeditor extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--feedimageeditor ${this.props.addClass}`
