...
class IconBlind extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--blind ${p.className || ""}`
        return (
