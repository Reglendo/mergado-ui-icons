...
class IconRa extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--ra ${p.className || ""}`
        return (
