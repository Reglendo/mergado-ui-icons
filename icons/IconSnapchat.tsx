...
class IconSnapchat extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--snapchat ${p.className || ""}`
        return (
