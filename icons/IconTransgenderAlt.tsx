...
class IconTransgenderAlt extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--transgender-alt ${p.className || ""}`
        return (
