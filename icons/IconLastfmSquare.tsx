...
class IconLastfmSquare extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--lastfm-square ${this.props.addClass}`
