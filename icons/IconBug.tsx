...
class IconBug extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--bug ${p.className || ""}`
        return (
