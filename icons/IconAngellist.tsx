...
class IconAngellist extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--angellist ${this.props.addClass}`
