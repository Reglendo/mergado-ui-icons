...
class IconAmbulance extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--ambulance ${p.className || ""}`
        return (
