...
class IconXingSquare extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--xing-square ${p.className || ""}`
        return (
