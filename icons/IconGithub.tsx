...
class IconGithub extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--github ${p.className || ""}`
        return (
