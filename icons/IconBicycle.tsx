...
class IconBicycle extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--bicycle ${p.className || ""}`
        return (
