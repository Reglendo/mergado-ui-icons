...
class IconEmpire extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--empire ${this.props.addClass} ${this.props.className}`
