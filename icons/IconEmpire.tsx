...
class IconEmpire extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--empire ${p.className || ""}`
        return (
