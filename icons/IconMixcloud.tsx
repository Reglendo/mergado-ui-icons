...
class IconMixcloud extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--mixcloud ${this.props.addClass}`
