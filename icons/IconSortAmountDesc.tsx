...
class IconSortAmountDesc extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--sort-amount-desc ${p.className || ""}`
        return (
