...
class IconMoney extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--money ${p.className || ""}`
        return (
