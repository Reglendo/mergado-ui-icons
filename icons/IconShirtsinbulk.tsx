...
class IconShirtsinbulk extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--shirtsinbulk ${this.props.addClass}`
