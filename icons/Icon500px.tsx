...
class Icon500px extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--500px ${this.props.addClass} ${this.props.className}`
