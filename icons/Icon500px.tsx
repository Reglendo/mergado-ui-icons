...
class Icon500px extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--500px ${p.className || ""}`
        return (
