...
class IconWheelchairAlt extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--wheelchair-alt ${p.className || ""}`
        return (
