...
class IconSlideshare extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--slideshare ${this.props.addClass} ${this.props.className}`
