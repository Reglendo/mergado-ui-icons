...
class IconDollar extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--dollar ${p.className || ""}`
        return (
