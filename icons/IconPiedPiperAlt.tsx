...
class IconPiedPiperAlt extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--pied-piper-alt ${this.props.addClass}`
