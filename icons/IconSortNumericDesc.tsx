...
class IconSortNumericDesc extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--sort-numeric-desc ${p.className || ""}`
        return (
