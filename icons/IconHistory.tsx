...
class IconHistory extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--history ${this.props.addClass}`
