...
class IconCog extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--cog ${this.props.addClass} ${this.props.className}`
