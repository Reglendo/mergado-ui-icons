...
class IconCameraRetro extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--camera-retro ${this.props.addClass} ${this.props.className}`
