...
class IconArrowCircleODown extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--arrow-circle-o-down ${p.className || ""}`
        return (
