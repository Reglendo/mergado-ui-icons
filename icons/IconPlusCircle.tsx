...
class IconPlusCircle extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--plus-circle ${p.className || ""}`
        return (
