...
class IconMicrophoneSlash extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--microphone-slash ${p.className || ""}`
        return (
