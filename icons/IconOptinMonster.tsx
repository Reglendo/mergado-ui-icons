...
class IconOptinMonster extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--optin-monster ${this.props.addClass}`
