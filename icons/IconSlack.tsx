...
class IconSlack extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--slack ${this.props.addClass}`
