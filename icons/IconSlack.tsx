...
class IconSlack extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--slack ${p.className || ""}`
        return (
