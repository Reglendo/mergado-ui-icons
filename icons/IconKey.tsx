...
class IconKey extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--key ${p.className || ""}`
        return (
