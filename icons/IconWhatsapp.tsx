...
class IconWhatsapp extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--whatsapp ${p.className || ""}`
        return (
