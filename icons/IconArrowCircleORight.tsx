...
class IconArrowCircleORight extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--arrow-circle-o-right ${this.props.addClass} ${this.props.className}`
