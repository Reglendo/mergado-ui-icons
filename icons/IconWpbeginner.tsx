...
class IconWpbeginner extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--wpbeginner ${p.className || ""}`
        return (
