...
class IconGlobe extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--globe ${this.props.addClass}`
