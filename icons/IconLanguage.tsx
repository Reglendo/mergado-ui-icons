...
class IconLanguage extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--language ${this.props.addClass}`
