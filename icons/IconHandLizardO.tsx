...
class IconHandLizardO extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--hand-lizard-o ${this.props.addClass}`
