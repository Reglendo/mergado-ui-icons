...
class IconSortNumericAsc extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon ${name}--sort-numeric-asc ${p.addClass} ${p.className}`
        return (
