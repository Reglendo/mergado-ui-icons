...
class IconYoutubeSquare extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--youtube-square ${p.className || ""}`
        return (
