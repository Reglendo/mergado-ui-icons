...
export const IconUserSecret: React.SFC<any> = props => {
    const name = "muk-icon";
    const className = `muk-icon ${name}--user-secret ${props.addClass} ${props.className}`
    return (
