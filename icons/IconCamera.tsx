...
class IconCamera extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--camera ${p.className || ""}`
        return (
