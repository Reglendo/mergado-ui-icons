...
class IconCalendar extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--calendar ${p.className || ""}`
        return (
