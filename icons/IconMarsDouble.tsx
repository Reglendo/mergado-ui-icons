...
class IconMarsDouble extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--mars-double ${p.className || ""}`
        return (
