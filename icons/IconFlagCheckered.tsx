...
class IconFlagCheckered extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--flag-checkered ${p.className || ""}`
        return (
