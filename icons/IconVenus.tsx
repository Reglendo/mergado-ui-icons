...
class IconVenus extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--venus ${this.props.addClass}`
