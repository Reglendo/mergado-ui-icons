...
class IconCommentingO extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--commenting-o ${p.className || ""}`
        return (
