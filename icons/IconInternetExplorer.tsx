...
class IconInternetExplorer extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--internet-explorer ${p.className || ""}`
        return (
