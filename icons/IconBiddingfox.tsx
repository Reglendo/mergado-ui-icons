...
class IconBiddingfox extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--biddingfox ${this.props.addClass}`
