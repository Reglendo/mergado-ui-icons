...
class IconCrosshairs extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--crosshairs ${p.className || ""}`
        return (
