...
class IconConnectdevelop extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--connectdevelop ${this.props.addClass}`
