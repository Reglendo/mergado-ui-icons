...
class IconShareSquareO extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--share-square-o ${this.props.addClass}`
