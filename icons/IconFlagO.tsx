...
class IconFlagO extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--flag-o ${p.className || ""}`
        return (
