...
class IconReglendo extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--reglendo ${this.props.addClass}`
