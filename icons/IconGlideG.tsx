...
class IconGlideG extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--glide-g ${p.className || ""}`
        return (
