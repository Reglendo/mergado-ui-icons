...
class IconCcAmex extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--cc-amex ${p.className || ""}`
        return (
