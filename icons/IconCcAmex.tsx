...
class IconCcAmex extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--cc-amex ${this.props.addClass} ${this.props.className}`
