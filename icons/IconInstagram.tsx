...
class IconInstagram extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--instagram ${this.props.addClass}`
