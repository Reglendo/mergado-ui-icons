...
class IconPlayCircleO extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--play-circle-o ${p.className || ""}`
        return (
