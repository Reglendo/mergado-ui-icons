...
class IconCcDiscover extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--cc-discover ${p.className || ""}`
        return (
