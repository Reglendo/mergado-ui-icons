...
class IconCcDiscover extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--cc-discover ${this.props.addClass} ${this.props.className}`
