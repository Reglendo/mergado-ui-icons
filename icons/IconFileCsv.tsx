...
class IconFileCsv extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--file-csv ${this.props.addClass} ${this.props.className}`
