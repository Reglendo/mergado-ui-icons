...
class IconHourglass1 extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--hourglass-1 ${this.props.addClass}`
