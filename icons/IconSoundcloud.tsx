...
class IconSoundcloud extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--soundcloud ${p.className || ""}`
        return (
