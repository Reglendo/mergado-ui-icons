...
class IconPrint extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--print ${p.className || ""}`
        return (
