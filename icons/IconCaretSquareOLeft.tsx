...
class IconCaretSquareOLeft extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--caret-square-o-left ${this.props.addClass} ${this.props.className}`
