...
class IconCaretSquareOLeft extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--caret-square-o-left ${p.className || ""}`
        return (
