...
export const IconSteamSquare: React.SFC<any> = props => {
    const name = "muk-icon";
    const className = `muk-icon ${name}--steam-square ${props.addClass} ${props.className}`
    return (
