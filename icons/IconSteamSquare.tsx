...
class IconSteamSquare extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--steam-square ${p.className || ""}`
        return (
