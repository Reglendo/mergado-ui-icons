...
export const IconRssSquare: React.SFC<any> = props => {
    const name = "muk-icon";
    const textEl = props.text ? <span className={`muk-icon__text`}>{props.text}</span> : false
    const className = `muk-icon ${name}--rss-square ${props.addClass} ${props.className}`
    return (
