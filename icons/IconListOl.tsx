...
class IconListOl extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--list-ol ${p.className || ""}`
        return (
