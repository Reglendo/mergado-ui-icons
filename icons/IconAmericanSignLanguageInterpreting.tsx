...
class IconAmericanSignLanguageInterpreting extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--american-sign-language-interpreting ${p.className || ""}`
        return (
