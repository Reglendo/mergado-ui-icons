...
class IconAmericanSignLanguageInterpreting extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--american-sign-language-interpreting ${this.props.addClass} ${this.props.className}`
