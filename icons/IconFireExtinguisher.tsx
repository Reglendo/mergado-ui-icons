...
class IconFireExtinguisher extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--fire-extinguisher ${this.props.addClass} ${this.props.className}`
