...
class IconFireExtinguisher extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--fire-extinguisher ${this.props.addClass}`
