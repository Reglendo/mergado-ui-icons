...
class IconPhone extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--phone ${this.props.addClass} ${this.props.className}`
