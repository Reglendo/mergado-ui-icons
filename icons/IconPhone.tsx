...
class IconPhone extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--phone ${this.props.addClass}`
