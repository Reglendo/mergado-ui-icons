...
class IconCcStripe extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--cc-stripe ${p.className || ""}`
        return (
