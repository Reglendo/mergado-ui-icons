...
class IconCcStripe extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--cc-stripe ${this.props.addClass} ${this.props.className}`
