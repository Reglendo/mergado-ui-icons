...
export const IconFolderOpenO: React.SFC<any> = props => {
    const name = "muk-icon";
    const className = `muk-icon ${name}--folder-open-o ${props.addClass} ${props.className}`
    return (
