...
class IconTextHeight extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--text-height ${p.className || ""}`
        return (
