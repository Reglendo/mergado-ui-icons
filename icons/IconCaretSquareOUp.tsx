...
class IconCaretSquareOUp extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--caret-square-o-up ${this.props.addClass} ${this.props.className}`
