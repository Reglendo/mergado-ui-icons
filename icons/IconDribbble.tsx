...
class IconDribbble extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--dribbble ${p.className || ""}`
        return (
