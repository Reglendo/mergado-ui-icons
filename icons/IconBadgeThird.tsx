...
class IconBadgeThird extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--badge-third ${this.props.addClass}`
