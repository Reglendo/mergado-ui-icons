...
class IconCcDinersClub extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--cc-diners-club ${p.className || ""}`
        return (
