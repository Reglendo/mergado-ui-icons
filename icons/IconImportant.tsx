...
class IconImportant extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--important ${this.props.addClass}`
