...
export const IconCopyright: React.SFC<any> = props => {
    const name = "muk-icon";
    const className = `muk-icon ${name}--copyright ${props.addClass} ${props.className}`
    return (
