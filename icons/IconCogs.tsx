...
class IconCogs extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--cogs ${p.className || ""}`
        return (
