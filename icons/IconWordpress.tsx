...
class IconWordpress extends React.Component<Props, State> {
    ...
    render() {
        let className = `${this.name} ${this.name}--wordpress ${this.props.addClass}`
