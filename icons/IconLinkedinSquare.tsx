...
class IconLinkedinSquare extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--linkedin-square ${p.className || ""}`
        return (
