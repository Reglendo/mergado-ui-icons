...
class IconHandGrabO extends React.Component<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--hand-grab-o ${p.className || ""}`
        return (
