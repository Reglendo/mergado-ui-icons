...
class IconCopy extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--copy ${p.className || ""}`
        return (
