...
class IconEllipsisV extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--ellipsis-v ${p.className || ""}`
        return (
