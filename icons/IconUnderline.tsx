...
class IconUnderline extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--underline ${p.className || ""}`
        return (
