...
class IconUnderline extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon ${name}--underline ${p.addClass} ${p.className}`
        return (
