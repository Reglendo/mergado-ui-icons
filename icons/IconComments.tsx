...
class IconComments extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon m--comments ${p.className || ""}`
        return (
