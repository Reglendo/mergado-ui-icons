...
class IconCcMastercard extends React.Component<Props, State> {
    ...
    render() {
        let className = `muk-icon ${this.name}--cc-mastercard ${this.props.addClass} ${this.props.className}`
