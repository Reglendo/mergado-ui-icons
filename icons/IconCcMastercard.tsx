...
class IconCcMastercard extends React.PureComponent<Props, {}> {
    ...
    render() {
        ...
        const className = `muk-icon muk-icon--cc-mastercard ${p.className || ""}`
        return (
