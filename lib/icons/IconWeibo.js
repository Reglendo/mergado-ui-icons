...
var IconWeibo = (function (_super) {
    __extends(IconWeibo, _super);
    function IconWeibo() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconWeibo.prototype.render = function () {
        var className = this.name + " " + this.name + "--weibo " + this.props.addClass;
