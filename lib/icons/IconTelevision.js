...
var IconTelevision = (function (_super) {
    __extends(IconTelevision, _super);
    function IconTelevision() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconTelevision.prototype.render = function () {
        var className = this.name + " " + this.name + "--television " + this.props.addClass;
...
exports.default = IconTelevision;
