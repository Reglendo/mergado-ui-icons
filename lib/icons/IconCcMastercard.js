...
var IconCcMastercard = (function (_super) {
    __extends(IconCcMastercard, _super);
    function IconCcMastercard() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCcMastercard.prototype.render = function () {
        var className = this.name + " " + this.name + "--cc-mastercard " + this.props.addClass;
...
exports.default = IconCcMastercard;
