...
var IconOptinMonster = (function (_super) {
    __extends(IconOptinMonster, _super);
    function IconOptinMonster() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconOptinMonster.prototype.render = function () {
        var className = this.name + " " + this.name + "--optin-monster " + this.props.addClass;
...
exports.default = IconOptinMonster;
