...
var IconClockO = (function (_super) {
    __extends(IconClockO, _super);
    function IconClockO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconClockO.prototype.render = function () {
        var className = this.name + " " + this.name + "--clock-o " + this.props.addClass;
