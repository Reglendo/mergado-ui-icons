...
var IconMarsStrokeH = (function (_super) {
    __extends(IconMarsStrokeH, _super);
    function IconMarsStrokeH() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMarsStrokeH.prototype.render = function () {
        var className = this.name + " " + this.name + "--mars-stroke-h " + this.props.addClass;
    ...
    return IconMarsStrokeH;
}(React.Component));
exports.default = IconMarsStrokeH;
