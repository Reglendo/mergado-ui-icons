...
var IconRefresh = (function (_super) {
    __extends(IconRefresh, _super);
    function IconRefresh() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconRefresh.prototype.render = function () {
        var className = this.name + " " + this.name + "--refresh " + this.props.addClass;
