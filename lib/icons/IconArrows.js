...
var IconArrows = (function (_super) {
    __extends(IconArrows, _super);
    function IconArrows() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconArrows.prototype.render = function () {
        var className = this.name + " " + this.name + "--arrows " + this.props.addClass;
