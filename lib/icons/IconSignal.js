...
var IconSignal = (function (_super) {
    __extends(IconSignal, _super);
    function IconSignal() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSignal.prototype.render = function () {
        var className = this.name + " " + this.name + "--signal " + this.props.addClass;
