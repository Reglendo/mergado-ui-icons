...
var IconSearchPlus = (function (_super) {
    __extends(IconSearchPlus, _super);
    function IconSearchPlus() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSearchPlus.prototype.render = function () {
        var className = this.name + " " + this.name + "--search-plus " + this.props.addClass;
...
exports.default = IconSearchPlus;
