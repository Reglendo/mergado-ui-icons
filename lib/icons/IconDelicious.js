...
var IconDelicious = (function (_super) {
    __extends(IconDelicious, _super);
    function IconDelicious() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconDelicious.prototype.render = function () {
        var className = this.name + " " + this.name + "--delicious " + this.props.addClass;
