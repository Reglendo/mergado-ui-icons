...
var IconPlayCircle = (function (_super) {
    __extends(IconPlayCircle, _super);
    function IconPlayCircle() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconPlayCircle.prototype.render = function () {
        var className = this.name + " " + this.name + "--play-circle " + this.props.addClass;
