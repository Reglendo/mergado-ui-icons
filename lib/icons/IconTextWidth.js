...
var IconTextWidth = (function (_super) {
    __extends(IconTextWidth, _super);
    function IconTextWidth() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconTextWidth.prototype.render = function () {
        var className = this.name + " " + this.name + "--text-width " + this.props.addClass;
