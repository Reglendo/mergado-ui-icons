...
var IconAngleDown = (function (_super) {
    __extends(IconAngleDown, _super);
    function IconAngleDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAngleDown.prototype.render = function () {
        var className = this.name + " " + this.name + "--angle-down " + this.props.addClass;
