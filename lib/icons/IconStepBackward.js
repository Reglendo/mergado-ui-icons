...
var IconStepBackward = (function (_super) {
    __extends(IconStepBackward, _super);
    function IconStepBackward() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconStepBackward.prototype.render = function () {
        var className = this.name + " " + this.name + "--step-backward " + this.props.addClass;
...
exports.default = IconStepBackward;
