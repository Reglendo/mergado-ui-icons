...
var IconShirtsinbulk = (function (_super) {
    __extends(IconShirtsinbulk, _super);
    function IconShirtsinbulk() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconShirtsinbulk.prototype.render = function () {
        var className = this.name + " " + this.name + "--shirtsinbulk " + this.props.addClass;
...
exports.default = IconShirtsinbulk;
