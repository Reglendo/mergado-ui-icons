...
var IconCaretSquareODown = (function (_super) {
    __extends(IconCaretSquareODown, _super);
    function IconCaretSquareODown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCaretSquareODown.prototype.render = function () {
        var className = this.name + " " + this.name + "--caret-square-o-down " + this.props.addClass;
...
exports.default = IconCaretSquareODown;
