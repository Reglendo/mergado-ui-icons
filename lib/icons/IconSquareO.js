...
var IconSquareO = (function (_super) {
    __extends(IconSquareO, _super);
    function IconSquareO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSquareO.prototype.render = function () {
        var className = this.name + " " + this.name + "--square-o " + this.props.addClass;
