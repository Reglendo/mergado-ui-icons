...
var IconCommentingO = (function (_super) {
    __extends(IconCommentingO, _super);
    function IconCommentingO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCommentingO.prototype.render = function () {
        var className = this.name + " " + this.name + "--commenting-o " + this.props.addClass;
...
exports.default = IconCommentingO;
