...
var IconSnapchatGhost = (function (_super) {
    __extends(IconSnapchatGhost, _super);
    function IconSnapchatGhost() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSnapchatGhost.prototype.render = function () {
        var className = this.name + " " + this.name + "--snapchat-ghost " + this.props.addClass;
...
exports.default = IconSnapchatGhost;
