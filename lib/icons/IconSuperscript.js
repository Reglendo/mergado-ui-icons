...
var IconSuperscript = (function (_super) {
    __extends(IconSuperscript, _super);
    function IconSuperscript() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSuperscript.prototype.render = function () {
        var className = this.name + " " + this.name + "--superscript " + this.props.addClass;
