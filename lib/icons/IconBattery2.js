...
var IconBattery2 = (function (_super) {
    __extends(IconBattery2, _super);
    function IconBattery2() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBattery2.prototype.render = function () {
        var className = this.name + " " + this.name + "--battery-2 " + this.props.addClass;
