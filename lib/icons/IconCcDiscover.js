...
var IconCcDiscover = (function (_super) {
    __extends(IconCcDiscover, _super);
    function IconCcDiscover() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCcDiscover.prototype.render = function () {
        var className = this.name + " " + this.name + "--cc-discover " + this.props.addClass;
...
exports.default = IconCcDiscover;
