...
var IconBattery3 = (function (_super) {
    __extends(IconBattery3, _super);
    function IconBattery3() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBattery3.prototype.render = function () {
        var className = this.name + " " + this.name + "--battery-3 " + this.props.addClass;
