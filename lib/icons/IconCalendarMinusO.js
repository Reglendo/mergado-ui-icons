...
var IconCalendarMinusO = (function (_super) {
    __extends(IconCalendarMinusO, _super);
    function IconCalendarMinusO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCalendarMinusO.prototype.render = function () {
        var className = this.name + " " + this.name + "--calendar-minus-o " + this.props.addClass;
...
exports.default = IconCalendarMinusO;
