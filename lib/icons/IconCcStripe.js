...
var IconCcStripe = (function (_super) {
    __extends(IconCcStripe, _super);
    function IconCcStripe() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCcStripe.prototype.render = function () {
        var className = this.name + " " + this.name + "--cc-stripe " + this.props.addClass;
