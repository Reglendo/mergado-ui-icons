...
var IconYelp = (function (_super) {
    __extends(IconYelp, _super);
    function IconYelp() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconYelp.prototype.render = function () {
        var className = this.name + " " + this.name + "--yelp " + this.props.addClass;
