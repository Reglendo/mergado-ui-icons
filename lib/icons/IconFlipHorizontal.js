...
var IconFlipHorizontal = (function (_super) {
    __extends(IconFlipHorizontal, _super);
    function IconFlipHorizontal() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFlipHorizontal.prototype.render = function () {
        var className = this.name + " " + this.name + "--flip-horizontal " + this.props.addClass;
