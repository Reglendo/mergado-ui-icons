...
class IconFileXml extends React.PureComponent {
    render() {
        const p = this.props;
        const name = "muk-icon";
        ...
        return (React.createElement("span", { className: className, style: p.style, title: p.title },
            ...
            React.createElement("svg", { className: `m-image`, preserveAspectRatio: 'xMidYMid meet', fill: p.color, stroke: p.color, strokeWidth: 0, height: p.size, width: p.size, viewBox: p.viewBox },
                React.createElement("g", { className: `m-group` },
                    ...
                    React.createElement("path", { d: "M9.979 31.69l-2.613-3.536h2.451l1.48 2.146 1.5-2.146h2.451l-2.612 3.523 2.742 3.718h-2.451l-1.63-2.289-1.61 2.29h-2.45L9.98 31.69zm13.416-2.334q.44-.672 1.041-1.021.608-.356 1.332-.356 1.248 0 1.901.77.653.769.653 2.237v4.41h-2.327v-3.777q.006-.084.006-.174.006-.09.006-.259 0-.77-.226-1.112-.226-.35-.73-.35-.66 0-1.022.544-.356.543-.369 1.571v3.556h-2.327V31.62q0-1.202-.207-1.545-.207-.35-.737-.35-.666 0-1.028.55-.363.543-.363 1.559v3.562h-2.327v-7.241h2.327v1.06q.427-.614.977-.925.556-.31 1.222-.31.75 0 1.325.362.576.362.873 1.015zm7.1-4.022h2.315v10.061h-2.315v-10.06z", style: { "lineHeight": "125%", "textAlign": "end" } }))),
            !p.textFirst && textEl));
    }
}
