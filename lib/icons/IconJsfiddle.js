...
var IconJsfiddle = (function (_super) {
    __extends(IconJsfiddle, _super);
    function IconJsfiddle() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconJsfiddle.prototype.render = function () {
        var className = this.name + " " + this.name + "--jsfiddle " + this.props.addClass;
