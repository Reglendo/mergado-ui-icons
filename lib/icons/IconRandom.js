...
var IconRandom = (function (_super) {
    __extends(IconRandom, _super);
    function IconRandom() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconRandom.prototype.render = function () {
        var className = this.name + " " + this.name + "--random " + this.props.addClass;
