...
var IconBellO = (function (_super) {
    __extends(IconBellO, _super);
    function IconBellO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBellO.prototype.render = function () {
        var className = this.name + " " + this.name + "--bell-o " + this.props.addClass;
