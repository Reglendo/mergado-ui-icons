...
var IconOdnoklassnikiSquare = (function (_super) {
    __extends(IconOdnoklassnikiSquare, _super);
    function IconOdnoklassnikiSquare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconOdnoklassnikiSquare.prototype.render = function () {
        var className = this.name + " " + this.name + "--odnoklassniki-square " + this.props.addClass;
    ...
    return IconOdnoklassnikiSquare;
}(React.Component));
exports.default = IconOdnoklassnikiSquare;
