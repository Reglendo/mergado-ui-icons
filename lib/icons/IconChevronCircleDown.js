...
var IconChevronCircleDown = (function (_super) {
    __extends(IconChevronCircleDown, _super);
    function IconChevronCircleDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconChevronCircleDown.prototype.render = function () {
        var className = this.name + " " + this.name + "--chevron-circle-down " + this.props.addClass;
...
exports.default = IconChevronCircleDown;
