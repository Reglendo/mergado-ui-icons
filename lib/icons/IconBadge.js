...
class IconBadge extends React.Component {
    ...
    render() {
        let className = `muk-icon ${this.name}--badge ${this.props.addClass} ${this.props.className}`;
