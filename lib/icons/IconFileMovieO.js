...
var IconFileMovieO = (function (_super) {
    __extends(IconFileMovieO, _super);
    function IconFileMovieO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFileMovieO.prototype.render = function () {
        var className = this.name + " " + this.name + "--file-movie-o " + this.props.addClass;
...
exports.default = IconFileMovieO;
