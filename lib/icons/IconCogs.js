...
var IconCogs = (function (_super) {
    __extends(IconCogs, _super);
    function IconCogs() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCogs.prototype.render = function () {
        var className = this.name + " " + this.name + "--cogs " + this.props.addClass;
