...
var IconIntersex = (function (_super) {
    __extends(IconIntersex, _super);
    function IconIntersex() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconIntersex.prototype.render = function () {
        var className = this.name + " " + this.name + "--intersex " + this.props.addClass;
