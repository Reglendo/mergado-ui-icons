...
var IconSortNumericDesc = (function (_super) {
    __extends(IconSortNumericDesc, _super);
    function IconSortNumericDesc() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSortNumericDesc.prototype.render = function () {
        var className = this.name + " " + this.name + "--sort-numeric-desc " + this.props.addClass;
    ...
    return IconSortNumericDesc;
}(React.Component));
exports.default = IconSortNumericDesc;
