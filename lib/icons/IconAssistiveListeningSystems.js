...
var IconAssistiveListeningSystems = (function (_super) {
    __extends(IconAssistiveListeningSystems, _super);
    function IconAssistiveListeningSystems() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAssistiveListeningSystems.prototype.render = function () {
        var className = this.name + " " + this.name + "--assistive-listening-systems " + this.props.addClass;
    ...
    return IconAssistiveListeningSystems;
}(React.Component));
exports.default = IconAssistiveListeningSystems;
