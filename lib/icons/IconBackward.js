...
var IconBackward = (function (_super) {
    __extends(IconBackward, _super);
    function IconBackward() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBackward.prototype.render = function () {
        var className = this.name + " " + this.name + "--backward " + this.props.addClass;
