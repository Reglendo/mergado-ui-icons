...
var IconHandODown = (function (_super) {
    __extends(IconHandODown, _super);
    function IconHandODown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconHandODown.prototype.render = function () {
        var className = this.name + " " + this.name + "--hand-o-down " + this.props.addClass;
