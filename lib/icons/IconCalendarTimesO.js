...
var IconCalendarTimesO = (function (_super) {
    __extends(IconCalendarTimesO, _super);
    function IconCalendarTimesO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCalendarTimesO.prototype.render = function () {
        var className = this.name + " " + this.name + "--calendar-times-o " + this.props.addClass;
...
exports.default = IconCalendarTimesO;
