...
var IconDotCircleO = (function (_super) {
    __extends(IconDotCircleO, _super);
    function IconDotCircleO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconDotCircleO.prototype.render = function () {
        var className = this.name + " " + this.name + "--dot-circle-o " + this.props.addClass;
    ...
    return IconDotCircleO;
}(React.Component));
exports.default = IconDotCircleO;
