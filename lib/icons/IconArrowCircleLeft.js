...
var IconArrowCircleLeft = (function (_super) {
    __extends(IconArrowCircleLeft, _super);
    function IconArrowCircleLeft() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconArrowCircleLeft.prototype.render = function () {
        var className = this.name + " " + this.name + "--arrow-circle-left " + this.props.addClass;
