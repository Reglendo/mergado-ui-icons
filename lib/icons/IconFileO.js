...
var IconFileO = (function (_super) {
    __extends(IconFileO, _super);
    function IconFileO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFileO.prototype.render = function () {
        var className = this.name + " " + this.name + "--file-o " + this.props.addClass;
