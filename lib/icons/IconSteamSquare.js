...
var IconSteamSquare = (function (_super) {
    __extends(IconSteamSquare, _super);
    function IconSteamSquare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSteamSquare.prototype.render = function () {
        var className = this.name + " " + this.name + "--steam-square " + this.props.addClass;
...
exports.default = IconSteamSquare;
