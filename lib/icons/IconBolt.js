...
var IconBolt = (function (_super) {
    __extends(IconBolt, _super);
    function IconBolt() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBolt.prototype.render = function () {
        var className = this.name + " " + this.name + "--bolt " + this.props.addClass;
