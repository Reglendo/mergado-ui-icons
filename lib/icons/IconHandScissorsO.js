...
var IconHandScissorsO = (function (_super) {
    __extends(IconHandScissorsO, _super);
    function IconHandScissorsO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconHandScissorsO.prototype.render = function () {
        var className = this.name + " " + this.name + "--hand-scissors-o " + this.props.addClass;
...
exports.default = IconHandScissorsO;
