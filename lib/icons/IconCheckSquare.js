...
var IconCheckSquare = (function (_super) {
    __extends(IconCheckSquare, _super);
    function IconCheckSquare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCheckSquare.prototype.render = function () {
        var className = this.name + " " + this.name + "--check-square " + this.props.addClass;
