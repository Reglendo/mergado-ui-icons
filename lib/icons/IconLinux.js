...
var IconLinux = (function (_super) {
    __extends(IconLinux, _super);
    function IconLinux() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconLinux.prototype.render = function () {
        var className = this.name + " " + this.name + "--linux " + this.props.addClass;
