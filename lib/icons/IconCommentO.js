...
var IconCommentO = (function (_super) {
    __extends(IconCommentO, _super);
    function IconCommentO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCommentO.prototype.render = function () {
        var className = this.name + " " + this.name + "--comment-o " + this.props.addClass;
