...
var IconAngleLeft = (function (_super) {
    __extends(IconAngleLeft, _super);
    function IconAngleLeft() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAngleLeft.prototype.render = function () {
        var className = this.name + " " + this.name + "--angle-left " + this.props.addClass;
