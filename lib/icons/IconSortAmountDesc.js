...
var IconSortAmountDesc = (function (_super) {
    __extends(IconSortAmountDesc, _super);
    function IconSortAmountDesc() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSortAmountDesc.prototype.render = function () {
        var className = this.name + " " + this.name + "--sort-amount-desc " + this.props.addClass;
...
exports.default = IconSortAmountDesc;
