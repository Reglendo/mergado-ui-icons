...
var IconArrowCircleOUp = (function (_super) {
    __extends(IconArrowCircleOUp, _super);
    function IconArrowCircleOUp() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconArrowCircleOUp.prototype.render = function () {
        var className = this.name + " " + this.name + "--arrow-circle-o-up " + this.props.addClass;
...
exports.default = IconArrowCircleOUp;
