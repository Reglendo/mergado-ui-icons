...
var IconYoutubeSquare = (function (_super) {
    __extends(IconYoutubeSquare, _super);
    function IconYoutubeSquare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconYoutubeSquare.prototype.render = function () {
        var className = this.name + " " + this.name + "--youtube-square " + this.props.addClass;
...
exports.default = IconYoutubeSquare;
