...
var IconHospitalO = (function (_super) {
    __extends(IconHospitalO, _super);
    function IconHospitalO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconHospitalO.prototype.render = function () {
        var className = this.name + " " + this.name + "--hospital-o " + this.props.addClass;
