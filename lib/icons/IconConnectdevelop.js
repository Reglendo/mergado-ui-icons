...
var IconConnectdevelop = (function (_super) {
    __extends(IconConnectdevelop, _super);
    function IconConnectdevelop() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconConnectdevelop.prototype.render = function () {
        var className = this.name + " " + this.name + "--connectdevelop " + this.props.addClass;
...
exports.default = IconConnectdevelop;
