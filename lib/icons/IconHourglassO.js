...
var IconHourglassO = (function (_super) {
    __extends(IconHourglassO, _super);
    function IconHourglassO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconHourglassO.prototype.render = function () {
        var className = this.name + " " + this.name + "--hourglass-o " + this.props.addClass;
    ...
    return IconHourglassO;
}(React.Component));
exports.default = IconHourglassO;
