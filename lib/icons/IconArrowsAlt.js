...
var IconArrowsAlt = (function (_super) {
    __extends(IconArrowsAlt, _super);
    function IconArrowsAlt() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconArrowsAlt.prototype.render = function () {
        var className = this.name + " " + this.name + "--arrows-alt " + this.props.addClass;
