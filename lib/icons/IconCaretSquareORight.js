...
var IconCaretSquareORight = (function (_super) {
    __extends(IconCaretSquareORight, _super);
    function IconCaretSquareORight() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCaretSquareORight.prototype.render = function () {
        var className = this.name + " " + this.name + "--caret-square-o-right " + this.props.addClass;
    ...
    return IconCaretSquareORight;
}(React.Component));
exports.default = IconCaretSquareORight;
