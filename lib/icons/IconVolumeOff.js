...
var IconVolumeOff = (function (_super) {
    __extends(IconVolumeOff, _super);
    function IconVolumeOff() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconVolumeOff.prototype.render = function () {
        var className = this.name + " " + this.name + "--volume-off " + this.props.addClass;
