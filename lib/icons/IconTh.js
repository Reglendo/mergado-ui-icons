...
var IconTh = (function (_super) {
    __extends(IconTh, _super);
    function IconTh() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconTh.prototype.render = function () {
        var className = this.name + " " + this.name + "--th " + this.props.addClass;
