...
var IconEmpire = (function (_super) {
    __extends(IconEmpire, _super);
    function IconEmpire() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconEmpire.prototype.render = function () {
        var className = this.name + " " + this.name + "--empire " + this.props.addClass;
