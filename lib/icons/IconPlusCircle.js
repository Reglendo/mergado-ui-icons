...
var IconPlusCircle = (function (_super) {
    __extends(IconPlusCircle, _super);
    function IconPlusCircle() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconPlusCircle.prototype.render = function () {
        var className = this.name + " " + this.name + "--plus-circle " + this.props.addClass;
