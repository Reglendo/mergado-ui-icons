...
var IconAngleDoubleRight = (function (_super) {
    __extends(IconAngleDoubleRight, _super);
    function IconAngleDoubleRight() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAngleDoubleRight.prototype.render = function () {
        var className = this.name + " " + this.name + "--angle-double-right " + this.props.addClass;
...
exports.default = IconAngleDoubleRight;
