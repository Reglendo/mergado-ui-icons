...
var IconMedkit = (function (_super) {
    __extends(IconMedkit, _super);
    function IconMedkit() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMedkit.prototype.render = function () {
        var className = this.name + " " + this.name + "--medkit " + this.props.addClass;
