...
var IconEllipsisV = (function (_super) {
    __extends(IconEllipsisV, _super);
    function IconEllipsisV() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconEllipsisV.prototype.render = function () {
        var className = this.name + " " + this.name + "--ellipsis-v " + this.props.addClass;
