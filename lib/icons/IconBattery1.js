...
var IconBattery1 = (function (_super) {
    __extends(IconBattery1, _super);
    function IconBattery1() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBattery1.prototype.render = function () {
        var className = this.name + " " + this.name + "--battery-1 " + this.props.addClass;
