...
var IconFileImageO = (function (_super) {
    __extends(IconFileImageO, _super);
    function IconFileImageO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFileImageO.prototype.render = function () {
        var className = this.name + " " + this.name + "--file-image-o " + this.props.addClass;
...
exports.default = IconFileImageO;
