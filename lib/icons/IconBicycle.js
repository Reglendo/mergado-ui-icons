...
var IconBicycle = (function (_super) {
    __extends(IconBicycle, _super);
    function IconBicycle() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBicycle.prototype.render = function () {
        var className = this.name + " " + this.name + "--bicycle " + this.props.addClass;
