...
var IconFileAudioO = (function (_super) {
    __extends(IconFileAudioO, _super);
    function IconFileAudioO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFileAudioO.prototype.render = function () {
        var className = this.name + " " + this.name + "--file-audio-o " + this.props.addClass;
...
exports.default = IconFileAudioO;
