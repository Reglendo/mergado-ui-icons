...
var IconStarHalf = (function (_super) {
    __extends(IconStarHalf, _super);
    function IconStarHalf() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconStarHalf.prototype.render = function () {
        var className = this.name + " " + this.name + "--star-half " + this.props.addClass;
