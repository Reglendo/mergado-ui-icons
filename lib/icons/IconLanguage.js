...
var IconLanguage = (function (_super) {
    __extends(IconLanguage, _super);
    function IconLanguage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconLanguage.prototype.render = function () {
        var className = this.name + " " + this.name + "--language " + this.props.addClass;
