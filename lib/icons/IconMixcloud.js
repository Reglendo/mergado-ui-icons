...
var IconMixcloud = (function (_super) {
    __extends(IconMixcloud, _super);
    function IconMixcloud() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMixcloud.prototype.render = function () {
        var className = this.name + " " + this.name + "--mixcloud " + this.props.addClass;
