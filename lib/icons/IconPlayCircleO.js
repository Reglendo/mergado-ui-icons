...
var IconPlayCircleO = (function (_super) {
    __extends(IconPlayCircleO, _super);
    function IconPlayCircleO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconPlayCircleO.prototype.render = function () {
        var className = this.name + " " + this.name + "--play-circle-o " + this.props.addClass;
    ...
    return IconPlayCircleO;
}(React.Component));
exports.default = IconPlayCircleO;
