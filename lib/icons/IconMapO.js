...
var IconMapO = (function (_super) {
    __extends(IconMapO, _super);
    function IconMapO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMapO.prototype.render = function () {
        var className = this.name + " " + this.name + "--map-o " + this.props.addClass;
