...
var IconPlusSquareO = (function (_super) {
    __extends(IconPlusSquareO, _super);
    function IconPlusSquareO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconPlusSquareO.prototype.render = function () {
        var className = this.name + " " + this.name + "--plus-square-o " + this.props.addClass;
...
exports.default = IconPlusSquareO;
