...
var IconSquare = (function (_super) {
    __extends(IconSquare, _super);
    function IconSquare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSquare.prototype.render = function () {
        var className = this.name + " " + this.name + "--square " + this.props.addClass;
