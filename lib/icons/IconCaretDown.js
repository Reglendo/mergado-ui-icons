...
var IconCaretDown = (function (_super) {
    __extends(IconCaretDown, _super);
    function IconCaretDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCaretDown.prototype.render = function () {
        var className = this.name + " " + this.name + "--caret-down " + this.props.addClass;
