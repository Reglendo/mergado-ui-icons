...
var IconMinusSquareO = (function (_super) {
    __extends(IconMinusSquareO, _super);
    function IconMinusSquareO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMinusSquareO.prototype.render = function () {
        var className = this.name + " " + this.name + "--minus-square-o " + this.props.addClass;
...
exports.default = IconMinusSquareO;
