...
var IconBookmark = (function (_super) {
    __extends(IconBookmark, _super);
    function IconBookmark() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBookmark.prototype.render = function () {
        var className = this.name + " " + this.name + "--bookmark " + this.props.addClass;
