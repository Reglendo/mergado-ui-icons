...
var IconMedium = (function (_super) {
    __extends(IconMedium, _super);
    function IconMedium() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMedium.prototype.render = function () {
        var className = this.name + " " + this.name + "--medium " + this.props.addClass;
