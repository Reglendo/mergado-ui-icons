...
var IconFastForward = (function (_super) {
    __extends(IconFastForward, _super);
    function IconFastForward() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFastForward.prototype.render = function () {
        var className = this.name + " " + this.name + "--fast-forward " + this.props.addClass;
