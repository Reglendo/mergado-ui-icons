...
var IconSafari = (function (_super) {
    __extends(IconSafari, _super);
    function IconSafari() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSafari.prototype.render = function () {
        var className = this.name + " " + this.name + "--safari " + this.props.addClass;
