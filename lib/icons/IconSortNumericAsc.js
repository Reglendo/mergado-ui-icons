...
var IconSortNumericAsc = (function (_super) {
    __extends(IconSortNumericAsc, _super);
    function IconSortNumericAsc() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSortNumericAsc.prototype.render = function () {
        var className = this.name + " " + this.name + "--sort-numeric-asc " + this.props.addClass;
...
exports.default = IconSortNumericAsc;
