...
var IconCalendarCheckO = (function (_super) {
    __extends(IconCalendarCheckO, _super);
    function IconCalendarCheckO() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCalendarCheckO.prototype.render = function () {
        var className = this.name + " " + this.name + "--calendar-check-o " + this.props.addClass;
...
exports.default = IconCalendarCheckO;
