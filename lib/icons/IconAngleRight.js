...
var IconAngleRight = (function (_super) {
    __extends(IconAngleRight, _super);
    function IconAngleRight() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAngleRight.prototype.render = function () {
        var className = this.name + " " + this.name + "--angle-right " + this.props.addClass;
