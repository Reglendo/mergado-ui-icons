...
var IconCcPaypal = (function (_super) {
    __extends(IconCcPaypal, _super);
    function IconCcPaypal() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconCcPaypal.prototype.render = function () {
        var className = this.name + " " + this.name + "--cc-paypal " + this.props.addClass;
