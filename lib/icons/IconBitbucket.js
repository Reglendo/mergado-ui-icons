...
var IconBitbucket = (function (_super) {
    __extends(IconBitbucket, _super);
    function IconBitbucket() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBitbucket.prototype.render = function () {
        var className = this.name + " " + this.name + "--bitbucket " + this.props.addClass;
...
exports.default = IconBitbucket;
//# sourceMappingURL=IconBitbucket.js.map