...
var IconVolumeDown = (function (_super) {
    __extends(IconVolumeDown, _super);
    function IconVolumeDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconVolumeDown.prototype.render = function () {
        var className = this.name + " " + this.name + "--volume-down " + this.props.addClass;
