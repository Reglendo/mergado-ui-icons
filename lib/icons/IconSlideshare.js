...
var IconSlideshare = (function (_super) {
    __extends(IconSlideshare, _super);
    function IconSlideshare() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconSlideshare.prototype.render = function () {
        var className = this.name + " " + this.name + "--slideshare " + this.props.addClass;
...
exports.default = IconSlideshare;
