...
var IconMars = (function (_super) {
    __extends(IconMars, _super);
    function IconMars() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMars.prototype.render = function () {
        var className = this.name + " " + this.name + "--mars " + this.props.addClass;
