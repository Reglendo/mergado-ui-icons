...
var IconUserTimes = (function (_super) {
    __extends(IconUserTimes, _super);
    function IconUserTimes() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconUserTimes.prototype.render = function () {
        var className = this.name + " " + this.name + "--user-times " + this.props.addClass;
