...
var IconFortAwesome = (function (_super) {
    __extends(IconFortAwesome, _super);
    function IconFortAwesome() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconFortAwesome.prototype.render = function () {
        var className = this.name + " " + this.name + "--fort-awesome " + this.props.addClass;
...
exports.default = IconFortAwesome;
