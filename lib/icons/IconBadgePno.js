...
var IconBadgePno = (function (_super) {
    __extends(IconBadgePno, _super);
    function IconBadgePno() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBadgePno.prototype.render = function () {
        var className = this.name + " " + this.name + "--badge-pno " + this.props.addClass;
