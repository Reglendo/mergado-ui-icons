...
var IconMarsDouble = (function (_super) {
    __extends(IconMarsDouble, _super);
    function IconMarsDouble() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconMarsDouble.prototype.render = function () {
        var className = this.name + " " + this.name + "--mars-double " + this.props.addClass;
    ...
    return IconMarsDouble;
}(React.Component));
exports.default = IconMarsDouble;
