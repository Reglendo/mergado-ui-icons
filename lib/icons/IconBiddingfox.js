...
var IconBiddingfox = (function (_super) {
    __extends(IconBiddingfox, _super);
    function IconBiddingfox() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconBiddingfox.prototype.render = function () {
        var className = this.name + " " + this.name + "--biddingfox " + this.props.addClass;
...
exports.default = IconBiddingfox;
