...
var IconTablet = (function (_super) {
    __extends(IconTablet, _super);
    function IconTablet() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconTablet.prototype.render = function () {
        var className = this.name + " " + this.name + "--tablet " + this.props.addClass;
