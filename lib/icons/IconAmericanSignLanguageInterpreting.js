...
var IconAmericanSignLanguageInterpreting = (function (_super) {
    __extends(IconAmericanSignLanguageInterpreting, _super);
    function IconAmericanSignLanguageInterpreting() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "muk-icon";
        return _this;
    }
    IconAmericanSignLanguageInterpreting.prototype.render = function () {
        var className = this.name + " " + this.name + "--american-sign-language-interpreting " + this.props.addClass;
    ...
    return IconAmericanSignLanguageInterpreting;
}(React.Component));
...
exports.default = IconAmericanSignLanguageInterpreting;
